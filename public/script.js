...
export let displayVersion = 'TurtleTavern (Go)';
...
async function getClientVersion() {
    try {
        ...
        displayVersion = `TurtleTavern (Go) ${data.pkgVersion}`;
...
async function firstLoadInit() {
    ...
    splashLogo.alt = 'TurtleTavern (Go)';
    splashLogo.className = 'splash-logo';
    splashLogo.ariaLabel = t`TurtleTavern (Go) Logo`;
    ...
    $('#chat_import_file').on('change', async function (e) {
        ...
        for (const file of targetElement.files) {
            ...
            if (selected_group && format === 'json') {
                toastr.warning(t`Only TurtleTavern (Go)'s own format is supported for group chat imports. Sorry!`);
                continue;
            }
